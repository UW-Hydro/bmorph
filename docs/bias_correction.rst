...
`Workflow functions`_ : ``apply_annual_bmorph``, ``apply_interval_bmorph``
...
`Workflow functions`_ : ``apply_annual_blendmorph``, ``apply_interval_blendmorph``
...
.. _`Workflow functions`: https://bmorph.readthedocs.io/en/develop/api.html#module-bmorph.core.workflows
